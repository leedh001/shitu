...
"}")
        ...
        self.page_3_layout = QVBoxLayout(self.page_3)
        self.page_3_layout.setObjectName(u"page_3_layout")
        self.thumbnail_list = QListView(self.page_3)
        self.thumbnail_list.setStyleSheet(
            "QListView { background: transparent; border: none; }"
            "QListView::item { background: transparent; }"
        )
        self.thumbnail_list.viewport().setAutoFillBackground(False)
        ...
        self.thumbnail_list.setLayoutMode(QListView.LayoutMode.Batched)
        ...
        self.page_3_layout.addWidget(self.thumbnail_list)
